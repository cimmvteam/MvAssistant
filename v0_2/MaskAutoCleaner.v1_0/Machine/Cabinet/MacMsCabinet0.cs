...
namespace MaskAutoCleaner.v1_0.Machine.Cabinet
{
    ...
    public class MacMsCabinet0 : MacMachineStateBase
    {
        ...
        private static MacMsCabinet0 _instance = null;
      
        public static MacMsCabinet0 GetInstance()
        {
            if (_instance == null)
            {
                lock (lockObj)
