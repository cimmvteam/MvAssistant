...
namespace MaskAutoCleaner.v1_0.Machine.BoxTransfer.OnEntryEventArgs
{
    ...
    public class MacStateMovingToDrawerEntryEventArgs: MacStateEntryEventArgs
    {
        ...
        public MacStateMovingToDrawerEntryEventArgs(BoxrobotTransferLocation drawerLocation, MacMaskBoxType boxType,object parameter ) :base(parameter)
        {
        ...
        public MacStateMovingToDrawerEntryEventArgs(BoxrobotTransferLocation drawerLocation,MacMaskBoxType boxType) : this(drawerLocation, boxType, null)
        {
            
        }
        public MacStateMovingToDrawerEntryEventArgs(object parameter) : this(BoxrobotTransferLocation.Dontcare,MacMaskBoxType.DontCare,parameter)
        {
