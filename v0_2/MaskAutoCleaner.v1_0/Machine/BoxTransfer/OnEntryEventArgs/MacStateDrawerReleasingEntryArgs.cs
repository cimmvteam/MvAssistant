...
namespace MaskAutoCleaner.v1_0.Machine.BoxTransfer.OnEntryEventArgs
{
    ...
    public  class MacStateDrawerReleasingEntryArgs : MacStateEntryEventArgs
    {
        ...
        public MacStateDrawerReleasingEntryArgs(BoxrobotTransferLocation drawerLocation,EnumMacMaskBoxType boxType, object parameter) : base(parameter)
        {
            DrawerLocation = drawerLocation;
            BoxType = boxType;

        }
        public MacStateDrawerReleasingEntryArgs(BoxrobotTransferLocation drawerLocation, EnumMacMaskBoxType boxType) : this(drawerLocation, boxType,null)
        {

        }
        public MacStateDrawerReleasingEntryArgs(object parameter) : this(BoxrobotTransferLocation.Dontcare,EnumMacMaskBoxType.DontCare ,parameter)
        {
