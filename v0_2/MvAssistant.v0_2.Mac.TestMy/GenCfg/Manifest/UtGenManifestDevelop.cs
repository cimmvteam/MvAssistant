    ...
    public class UtGenManifestDevelop : MacManifestGenCfgBase
    {
                ...
                Devices = new MacManifestDeviceCfg[] {
                    new MacManifestDeviceCfg(){
                     ...
                     new MacManifestDeviceCfg(){
                        ...
                        DeviceName = EnumMacDeviceId.boxtransfer_light_1.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_05_01()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_05_01.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_05_01.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_05_02()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_05_02.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_05_02.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_05_03()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_05_03.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_05_03.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_05_04()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_05_04.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_05_04.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_05_05()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_05_05.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_05_05.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_06_01()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_06_01.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_06_01.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_06_02()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_06_02.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_06_02.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_06_03()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_06_03.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_06_03.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_06_04()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_06_04.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_06_04.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_06_05()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_06_05.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_06_05.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_07_01()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_07_01.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_07_01.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_07_02()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_07_02.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_07_02.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_07_03()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_07_03.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_07_03.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_07_04()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_07_04.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_07_04.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
        ...
        MacManifestDeviceCfg DE_CB_A_07_05()
        {
            var rs = new MacManifestDeviceCfg()
            {
                ...
                ID = EnumMacHalId.HID_CB_A_07_05.ToString(),
                DevConnStr = null,
                DeviceName = EnumMacDeviceId.cabinet_drawer_07_05.ToString(),
                DriverId = MacManifestDriverId.Cabinet.ToString(),
                ...
                Devices = new MacManifestDeviceCfg[] {
                    ...
                    new MacManifestDeviceCfg(){
                        DevConnStr = string.Format("{0}={1};{2}={3};{4}={5};{6}={7}",
                            ...
                            MacHalLightLeimac.DevConnStr_Model, MvaEnumLeimacModel.IDGB_50M4PG_24_TP,
                            MacHalLightLeimac.DevConnStr_Channel, 3),
                        DeviceName = EnumMacDeviceId.loadport_light_bar_003.ToString(),
                        DriverId = MacManifestDriverId.LightLeimac.ToString(),
                    },
                    ...
                    new MacManifestDeviceCfg(){
                        ...
                        DeviceName = EnumMacDeviceId.loadportA_camera_inspect.ToString(),
                        DriverId = MacManifestDriverId.CameraSentech.ToString(),
                    },

                    new MacManifestDeviceCfg(){
                        DevConnStr = "id=00:11:1C:F9:A3:22",
                        DeviceName = EnumMacDeviceId.loadport_camera_barcode_inspect.ToString(),
                        DriverId = MacManifestDriverId.CameraSentech.ToString(),
                    },
                },
            };
                ...
                Devices = new MacManifestDeviceCfg[] {
                    ...
                    new MacManifestDeviceCfg(){
                        DevConnStr = string.Format("{0}={1};{2}={3};{4}={5};{6}={7}",
                            ...
                            MacHalLightLeimac.DevConnStr_Model, MvaEnumLeimacModel.IDGB_50M4PG_24_TP,
                            MacHalLightLeimac.DevConnStr_Channel, 2),
                        DeviceName = EnumMacDeviceId.loadport_light_bar_002.ToString(),
                        DriverId = MacManifestDriverId.LightLeimac.ToString(),
                    },
                    ...
                    new MacManifestDeviceCfg(){
                        ...
                        DeviceName = EnumMacDeviceId.loadportB_camera_inspect.ToString(),
                        DriverId = MacManifestDriverId.CameraSentech.ToString(),
                    },
                },
            };
                ...
                Devices = new MacManifestDeviceCfg[] {
                    ...
                    new MacManifestDeviceCfg(){
                        DevConnStr = string.Format("{0}={1};{2}={3};{4}={5};{6}={7}",
                            ...
                            MacHalLightLeimac.DevConnStr_Model, MvaEnumLeimacModel.IDGB_50M4PG_24_TP,
                            MacHalLightLeimac.DevConnStr_Channel, 2),
                        DeviceName = EnumMacDeviceId.openstage_light_bar_defense_front_001.ToString(),
                        DriverId = MacManifestDriverId.LightLeimac.ToString(),
                    },
