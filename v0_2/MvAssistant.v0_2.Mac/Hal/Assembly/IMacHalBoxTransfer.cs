...
namespace MvAssistant.v0_2.Mac.Hal.Assembly
{
    ...
    public interface IMacHalBoxTransfer : IMacHalAssembly
    {
        ...
        void SetClampSpeed(double ClampSpeed);
        ...
        /// <param name="Minimum">最小間距</param>
        void SetSpacingLimitBetweenClampAndCabinet(double Minimum);
        ...
        /// <returns></returns>
        double ReadClampSpeedSetting();

        /// <summary> 讀取夾爪間距的極限值設定，最小夾距、最大夾距 </summary>
        /// <returns>最小夾距、最大夾距</returns>
        Tuple<double, double> ReadClampSpacingLimitSetting();

        /// <summary> 讀取Clamp與Cabinet的最小間距限制 </summary>
        /// <returns>最小間</returns>
        double ReadSpacingLimitBetweenClampAndCabinetSetting();
