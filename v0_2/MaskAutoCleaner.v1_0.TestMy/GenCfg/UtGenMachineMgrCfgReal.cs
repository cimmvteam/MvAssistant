...
{
    [TestClass]
    public class UtGenMachineMgrCfgReal
    {
        [TestMethod]
        public void TestMethod1()
        {
            var cfg = new MacMachineMgrCfg();
            cfg.ManifestCfgPath = "UserData/Manifest/Manifest.xml.real";
            ...
            cfg.MachineCtrls.Add(new MacMachineCtrlCfg()
            {
                ...
                HalId = EnuDeviceId.HID_CB_A_01_01.ToString(),
            });
            ...
            cfg.MachineCtrls.Add(new MacMachineCtrlCfg()
            {
                ...
                MachineCtrlType = typeof(MacMcCabinetDrawer),
                HalId = EnuDeviceId.HID_CB_A_01_02.ToString(),
            });
            ...
            cfg.MachineCtrls.Add(new MacMachineCtrlCfg()
            {
                ...
                MachineCtrlType = typeof(MacMcCabinetDrawer),
                HalId = EnuDeviceId.HID_CB_A_01_03.ToString(),
            });
            cfg.MachineCtrls.Add(new MacMachineCtrlCfg()
            {
                ID = EnumMachineID.MID_DRAWER_01_04.ToString(),
                MachineCtrlType = typeof(MacMcCabinetDrawer),
                HalId = EnuDeviceId.HID_CB_A_01_04.ToString(),
            });
            var fn = "../../UserData/MachineMgr.config.real";
