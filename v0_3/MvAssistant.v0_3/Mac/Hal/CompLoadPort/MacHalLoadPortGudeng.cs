...
namespace MvAssistant.v0_3.Mac.Hal.CompLoadPort
{
    ...
    public class MacHalLoadPortGudeng : MacHalComponentBase, IMacHalLoadPortUnit
    {
        ...
        private void BindEvents()
        {
            ...
            _ldd.EhStageMotionTimeout += this.OnStageMotionTimeout;
            _ldd.EhStageOverUpLimitation += this.OnStageOverUpLimitation;
            _ldd.EhStageOverDownLimitation += this.OnStageOverDownLimitation;
            _ldd.EhReticlePositionAbnormality += this.OnReticlePositionAbnormality;
            _ldd.EhClamperLockPositionFailed += this.OnClamperLockPositionFailed;
