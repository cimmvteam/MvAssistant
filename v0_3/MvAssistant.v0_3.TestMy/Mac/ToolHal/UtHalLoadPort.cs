      ...
      public UtHalLoadPort()
      {
        ...
        public void BindEventHandler()
        {
            foreach(var loadport in ldd.LoadPorts)
            {
                ...
                loadport.EhClamperUnlockComplete += this.OnClamperLockComplete;//012
                ...
                loadport.EhClamperLockComplete += this.OnClamperUnlockComplete;//006
                loadport.EhClamperUnlockPositionFailed += this.OnClamperUnlockPositionFailed;//201
                loadport.EhPODPresentAbnormality += this.OnCoverDisappear;//208
