...
{
    [MachineManifest(EnumDevice.masktransfer_assembly)]
    ...
    public class HalMaskTransferFake : HalFakeBase, IHalMaskTransfer
    {
        ...
        [MachineManifest(EnumDevice.masktransfer_robot_1)]
        public IHalRobot Robot { get; set; }
        [MachineManifest(EnumDevice.masktransfer_force_6axis_sensor_1)]
        public IHalForce6Axis Force6Axis { get; set; }
        [MachineManifest(EnumDevice.masktransfer_inclinometer01)]
        public IHalInclinometer Gradienter { get; set; }
        [MachineManifest(EnumDevice.masktransfer_ccd_pellicle_deform_1)]
        public IHalCamera CameraPellicleDeform { get; set; }
        [MachineManifest(EnumDevice.masktransfer_ccd_barcode_reader_1)]
        public IHalCamera CameraBarcodeReader { get; set; }
        [MachineManifest(EnumDevice.masktransfer_light_barcode_1)]
        public IHalLight CameraBarcodeLight { get; set; }
        [MachineManifest(EnumDevice.masktransfer_stage_pellicle_deform_1)]
        public IHalPellicleDeformStage StagePellicleDeform { get; set; }
        [MachineManifest(EnumDevice.masktransfer_tactile_1)]
        public IHalTactile Tactile1 { get; set; }
        [MachineManifest(EnumDevice.masktransfer_tactile_2)]
        public IHalTactile Tactile2 { get; set; }
        [MachineManifest(EnumDevice.masktransfer_tactile_3)]
        public IHalTactile Tactile3 { get; set; }
        [MachineManifest(EnumDevice.masktransfer_tactile_4)]
        public IHalTactile Tactile4 { get; set; }
        [MachineManifest(EnumDevice.masktransfer_gripper_01)]
        public IHalGripper Gripper01 { get; set; }
        [MachineManifest(EnumDevice.masktransfer_gripper_02)]
        public IHalGripper Gripper02 { get; set; }
        [MachineManifest(EnumDevice.masktransfer_gripper_03)]
        public IHalGripper Gripper03 { get; set; }
        [MachineManifest(EnumDevice.masktransfer_gripper_04)]
        public IHalGripper Gripper04 { get; set; }
        [MachineManifest(EnumDevice.masktransfer_light_interrupt_1)]
        public IHalInfraredPhotointerrupter InfraLight { get; set; }
        [MachineManifest(EnumDevice.masktransfer_robot_skin_1)]
        public IHalRobotSkin RobotSkin { get; set; }
        [MachineManifest(EnumDevice.masktransfer_static_electricity_detector_1)]
