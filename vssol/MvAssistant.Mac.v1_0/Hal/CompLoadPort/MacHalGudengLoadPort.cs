...
namespace MvAssistant.Mac.v1_0.Hal.CompLoadPort
{
    ...
    public class MacHalGudengLoadPort : MacHalComponentBase, IMacHalLoadPortComp
    {
        ...
        private void BindEvents()
        {
            ...
            _ldd.OnClamperHandler += this.OnClamperHandler;
            _ldd.OnBarcode_IDHandler += this.OnBarcode_IDHandler;
            _ldd.OnClamperLockCompleteHandler += this.OnClamperLockCompleteHandler;
            _ldd.OnVacuumCompleteHandler += this.OnVacuumCompleteHandler;
            _ldd.OnDockPODStartHandler += this.OnDockPODStartHandler;
            _ldd.OnDockPODComplete_HasReticleHandler += this.OnDockPODComplete_HasReticleHandler;
            ...
            _ldd.OnStagePositionHandler += this.OnStagePositionHandler;
            _ldd.OnLoadportStatusHandler += this.OnLoadportStatusHandler;
            _ldd.OnInitialCompleteHandler += this.OnInitialCompleteHandler;
            _ldd.OnInitialUnCompleteHandler += this.OnInitialUnCompleteHandler;
            _ldd.OnMustInAutoModeHandler += this.OnMustInAutoModeHandler;
            _ldd.OnMustInManualModeHandler += this.OnMustInManualModeHandler;
            _ldd.OnClamperNotLockHandler += this.OnClamperNotLockHandler;
            _ldd.OnPODNotPutProperlyHandler += this.OnPODNotPutProperlyHandler;
            _ldd.OnClamperActionTimeOutHandler += this.OnClamperActionTimeOutHandler;
            _ldd.OnClamperUnlockPositionFailedHandler += this.OnClamperUnlockPositionFailedHandler;
            _ldd.OnVacuumAbnormalityHandler += this.OnVacuumAbnormalityHandler;
            _ldd.OnStageMotionTimeoutHandler += this.OnStageMotionTimeoutHandler;
            _ldd.OnStageOverUpLimitationHandler += this.OnStageOverUpLimitationHandler;
            _ldd.OnStageOverDownLimitationHandler += this.OnStageOverDownLimitationHandler;
            _ldd.OnReticlePositionAbnormalityHandler += this.OnReticlePositionAbnormalityHandler;
            _ldd.OnClamperLockPositionFailedHandler += this.OnClamperLockPositionFailed;
            _ldd.OnPODPresentAbnormalityHandler += this.OnPODPresentAbnormalityHandler;
