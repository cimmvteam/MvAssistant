...
{
    [Guid("B750234F-259F-4247-A615-4DED194F12B2")]
    public class MacHalPlcBoxTransferFake : MacHalPlcBase, IMacHalPlcBoxTransfer
    {


        public MacHalPlcBoxTransferFake() { }
        public MacHalPlcBoxTransferFake(MacHalPlcContext plc = null)
        {
            this.plcContext = plc;
        }
