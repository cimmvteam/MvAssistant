...
{
    [Guid("91066A6E-0E43-4B3D-A1CD-5858BA36A769")]
    public class MacHalPlcOpenStageFake : MacHalPlcBase, IMacHalPlcOpenStage
    {


        public MacHalPlcOpenStageFake() { }
        public MacHalPlcOpenStageFake(MacHalPlcContext plc = null)
        {
            this.plcContext = plc;
        }
