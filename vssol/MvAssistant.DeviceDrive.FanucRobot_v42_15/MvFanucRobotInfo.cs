...
namespace MvAssistant.DeviceDrive.FanucRobot_v42_15
{
    ...
    public class MvFanucRobotInfo
    {
        ...
        public float e2 { get { return (float)this.posArray.GetValue(7); } set { this.posArray.SetValue(value, 7); } }
        public float e3 { get { return (float)this.posArray.GetValue(8); } set { this.posArray.SetValue(value, 8); } }
