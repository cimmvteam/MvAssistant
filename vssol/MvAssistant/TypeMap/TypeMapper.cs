...
namespace MvAssistant.TypeMap
{
    ...
    {
        static TypeMapper m_Singleton;
        SortedDictionary<string, Type> mapper;
        public static TypeMapper Singleton { get { if (m_Singleton == null) { m_Singleton = new TypeMapper(); } return m_Singleton; } }
