...
namespace MaskAutoCleaner.v1_0.Machine
{
    public class MacMachineMgrCfg
    {
        ...
        /// <returns></returns>
        public static MacMachineMgrCfg LoadFromXmlFile(string filePath = "../../UserData/MachineMgr.config.real") { return MvUtil.LoadFromXmlFile<MacMachineMgrCfg>(filePath); }
        /// <summary>
